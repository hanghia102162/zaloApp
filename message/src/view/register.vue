<template>
  ...
  >
    ...
    >
      ...
      >
        <h1 class="font-medium text-2xl">Đăng kí tài khoản zalo</h1>
        <div class="w-full relative">
          ...
          <label
            for="otp1"
            class="absolute left-2 top-1/2 -translate-y-1/2 peer-not-placeholder-shown:top-[-10px] peer-not-placeholder-shown:text-sm peer-focus:top-[-10px] transition-all duration-500 ease-linear peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-base"
            >Name</label
          >
        </div>
        <div class="w-full relative">
        ...
        <div class="w-full relative">
          ...
          <label
            for="otp2"
            class="absolute left-2 top-1/2 -translate-y-1/2 left-0 peer-not-placeholder-shown:top-[-10px] peer-not-placeholder-shown:text-sm peer-focus:top-[-10px] transition-all duration-500 ease-linear"
          >
            Mật khẩu
          </label>
        </div>
        ...
        <button @click="QuayLai">Quay Lai</button>
      </form>
    </div>
  </div>
</template>
